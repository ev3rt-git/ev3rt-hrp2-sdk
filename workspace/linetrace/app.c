...
void main_task(floatptr_t unused) {
    ...
    if(tosks[2] == 0 && tosks[3] == 0 && pos.street == 2){
        float snowValues[6][2] = {{11,150},{17,-150},{121,-150},{139,150},{1000,0},{1000,0}};
    ...
    if(tosks[2] == 0 && tosks[3] == 0 && pos.street == 3){
        float snowValues[6][2] = {{30,150},{70,150},{100,150},{1000,0},{1000,0},{1000,0}};
        dashPID(160,snowValues);
    }
}
...
void dashPID(float distance,float snow[6][2]){
    ev3_motor_reset_counts(left_motor);
    ev3_motor_reset_counts(right_motor);
    ev3_motor_reset_counts(a_motor);
